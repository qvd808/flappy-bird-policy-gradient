...
if __name__ == "__main__":
    ...
    q_table = np.zeros((v_bin, h_bin, v_bin, h_bin, 2), dtype=np.float32)
    ...
    for i in range(n_training_episode):
        for step in range(max_step):
            ...
            n1, n2, n3, n4 = discretize_state(n_obs, v_bin, h_bin)

            update_Qtable(q_table, (i1, i2, i3, i4), (n1, n2, n3, n4), action, reward)
